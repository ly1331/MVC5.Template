Function Scaffold-CsTemplate([String]$Template, [String]$Project, [String]$OutputPath)
{
    ...
    $ControllerNamespace = "YZMIS.Controllers"
    $ControllerTestsNamespace = "YZMIS.Tests.Unit.Controllers"
    If ($Area) { $ControllerNamespace = "YZMIS.Controllers.$Area" }
    If ($Area) { $ControllerTestsNamespace = "YZMIS.Tests.Unit.Controllers.$Area" }
...
Function Scaffold-AreaRegistration([String]$Template, [String]$Project, [String]$OutputPath)
{
    if (!$Delete)
    {
        $ControllerNamespace = "YZMIS.Controllers.$Area"
        $ControllerTestsNamespace = "YZMIS.Tests.Unit.Controllers.$Area"
