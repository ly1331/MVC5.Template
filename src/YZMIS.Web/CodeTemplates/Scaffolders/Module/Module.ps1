...
$DataProject = "YZMIS.Data"
$TestsProject = "YZMIS.Tests"
$RazorViewProject = "YZMIS.Web"
$ObjectsProject = "YZMIS.Objects"
$ServiceProject = "YZMIS.Services"
$ValidatorProject = "YZMIS.Validators"
$ControllerProject = "YZMIS.Controllers"
